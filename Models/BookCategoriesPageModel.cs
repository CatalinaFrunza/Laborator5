...
namespace Frunza_Catalina_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList = null!;

        public void PopulateAssignedCategoryData(Frunza_Catalina_Lab2Context context, Book book)
        {
        ...
        public async Task UpdateBookCategories(Frunza_Catalina_Lab2Context context, string[] selectedCategories, int bookId)
        {
